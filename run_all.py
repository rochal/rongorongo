...
if not args.fast:
    ...
    steps.append(["decipher_length.py"])     # a known Maori text at increasing lengths, about 20 minutes
...
if not args.fast:
    ...
    if (root / "data" / "boxes" / "Ev.json").exists():
        steps += [["register.py", "--sides", "Ev", "--ignore-hand", "--tag", "auto"], ["registration_score.py"]]
